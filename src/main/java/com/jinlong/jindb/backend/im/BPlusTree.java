...
import com.jinlong.jindb.backend.im.Node.InsertAndSplitRes;
import com.jinlong.jindb.backend.im.Node.LeafSearchRangeRes;
import com.jinlong.jindb.backend.im.Node.SearchNextRes;
...
public class BPlusTree {
    ...
    public static long create(DataManager dataManager) throws Exception {
        ...
        long rootUid = dataManager.insert(TransactionManagerImpl.SUPER_XID, rawRoot);
        return dataManager.insert(TransactionManagerImpl.SUPER_XID, Parser.long2Byte(rootUid));
    }

    public static BPlusTree load(long bootUid, DataManager dataManager) throws Exception {
        DataItem bootDataItem = dataManager.read(bootUid);
    ...
    private void updateRootUid(long left, long right, long rightKey) throws Exception {
        ...
        try {
            ...
            long newRootUid = dataManager.insert(TransactionManagerImpl.SUPER_XID, rootRaw);
            bootDataItem.before();
