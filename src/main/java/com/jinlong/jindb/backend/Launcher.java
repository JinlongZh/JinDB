package com.jinlong.jindb.backend;

import com.jinlong.jindb.backend.dm.DataManager;
import com.jinlong.jindb.backend.service.Server;
...
import com.jinlong.jindb.backend.vm.VersionManagerImpl;
...
public class Launcher {
    ...
    private static long parseMem(String memStr) {
        ...
        if(memStr.length() < 2) {
            Panic.panic(ErrorConstants.InvalidMemException);
        }
